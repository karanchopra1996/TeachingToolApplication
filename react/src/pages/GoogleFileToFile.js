...
function GoogleFileToFile(courseId) {
    ...
    return (
        <div style={{ textAlign: "center", color: "#4A2E83" }}>
            ...
            <h1 style={{ paddingTop: "60px", fontSize: 60 }}>Convert a Google Drive file to a Canvas File</h1>
            <p>
            ...
            <p style={{ textAlign: "center", color: "#4A2E83" }}>This page only currently works for non-Google-based file formats.</p>
            ...
            <div style={{ padding: 40 }}>
                ...
                <div align="center">
                    ...
                    <div align="center" style={{ marginTop: 10 }}>
                        <GoogleDrivePicker multiselect={true} response={sendFolder} style={{ backgroundColor: '#4A2E83' }} />
                    </div>
                </div>
...
export default GoogleFileToFile